...
/* 深色模式：prompt-mode badge 背景略調暗，避免在黑底上過亮（維護者 review 順手項）。
   只針對此 badge 覆蓋背景，不動共用的 --notch-fg-soft（錄音環邊框也用它）。 */
html.dark .notch-hud .prompt-mode-badge { background: rgba(255, 255, 255, 0.2); }
